...
#ifndef GOOGLE_PROTOBUF_INCLUDED_brokerage_5fto_5fbank_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_brokerage_5fto_5fbank_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_brokerage_5fto_5fbank_2eproto
...
struct TableStruct_brokerage_5fto_5fbank_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_brokerage_5fto_5fbank_2eproto;
...
class Withdraw final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:brokerage_to_bank.Withdraw) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "brokerage_to_bank.Withdraw";
  }
  protected:
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_brokerage_5fto_5fbank_2eproto;
};
// -------------------------------------------------------------------

class Deposit final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:brokerage_to_bank.Deposit) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "brokerage_to_bank.Deposit";
  }
  protected:
...
class UpdateAccount final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:brokerage_to_bank.UpdateAccount) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "brokerage_to_bank.UpdateAccount";
  }
  protected:
  ...
  PROTOBUF_NODISCARD ::brokerage_to_bank::Withdraw* release_withdraw();
  ...
  ::brokerage_to_bank::Withdraw* _internal_mutable_withdraw();
  public:
  void unsafe_arena_set_allocated_withdraw(
      ::brokerage_to_bank::Withdraw* withdraw);
  ::brokerage_to_bank::Withdraw* unsafe_arena_release_withdraw();
  ...
  PROTOBUF_NODISCARD ::brokerage_to_bank::Deposit* release_deposit();
  ...
  ::brokerage_to_bank::Deposit* _internal_mutable_deposit();
  public:
  void unsafe_arena_set_allocated_deposit(
      ::brokerage_to_bank::Deposit* deposit);
  ::brokerage_to_bank::Deposit* unsafe_arena_release_deposit();
...
class Ack final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:brokerage_to_bank.Ack) */ {
 public:
  ...
  private:
  ::brokerage_to_bank::Ack_ResponseType _internal_response() const;
  void _internal_set_response(::brokerage_to_bank::Ack_ResponseType value);
  public:
...
inline void Withdraw::unsafe_arena_set_allocated_brokerage_id(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:brokerage_to_bank.Withdraw.brokerage_id)
}
...
inline void Withdraw::unsafe_arena_set_allocated_price(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:brokerage_to_bank.Withdraw.price)
}
...
inline void Deposit::unsafe_arena_set_allocated_brokerage_id(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:brokerage_to_bank.Deposit.brokerage_id)
}
...
inline void Deposit::unsafe_arena_set_allocated_price(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:brokerage_to_bank.Deposit.price)
}
...
inline void UpdateAccount::unsafe_arena_set_allocated_header(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:brokerage_to_bank.UpdateAccount.header)
}
...
inline ::brokerage_to_bank::Withdraw* UpdateAccount::release_withdraw() {
  ...
  if (_internal_has_withdraw()) {
    clear_has_payload();
    ::brokerage_to_bank::Withdraw* temp = _impl_.payload_.withdraw_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
...
inline ::brokerage_to_bank::Withdraw* UpdateAccount::unsafe_arena_release_withdraw() {
  // @@protoc_insertion_point(field_unsafe_arena_release:brokerage_to_bank.UpdateAccount.withdraw)
  if (_internal_has_withdraw()) {
    clear_has_payload();
    ::brokerage_to_bank::Withdraw* temp = _impl_.payload_.withdraw_;
    _impl_.payload_.withdraw_ = nullptr;
...
inline void UpdateAccount::unsafe_arena_set_allocated_withdraw(::brokerage_to_bank::Withdraw* withdraw) {
  clear_payload();
  if (withdraw) {
    set_has_withdraw();
    _impl_.payload_.withdraw_ = withdraw;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:brokerage_to_bank.UpdateAccount.withdraw)
}
inline ::brokerage_to_bank::Withdraw* UpdateAccount::_internal_mutable_withdraw() {
  if (!_internal_has_withdraw()) {
    clear_payload();
    set_has_withdraw();
    _impl_.payload_.withdraw_ = CreateMaybeMessage< ::brokerage_to_bank::Withdraw >(GetArenaForAllocation());
  }
  return _impl_.payload_.withdraw_;
}
inline ::brokerage_to_bank::Withdraw* UpdateAccount::mutable_withdraw() {
  ::brokerage_to_bank::Withdraw* _msg = _internal_mutable_withdraw();
...
inline ::brokerage_to_bank::Deposit* UpdateAccount::release_deposit() {
  ...
  if (_internal_has_deposit()) {
    clear_has_payload();
    ::brokerage_to_bank::Deposit* temp = _impl_.payload_.deposit_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
...
inline ::brokerage_to_bank::Deposit* UpdateAccount::unsafe_arena_release_deposit() {
  // @@protoc_insertion_point(field_unsafe_arena_release:brokerage_to_bank.UpdateAccount.deposit)
  if (_internal_has_deposit()) {
    clear_has_payload();
    ::brokerage_to_bank::Deposit* temp = _impl_.payload_.deposit_;
    _impl_.payload_.deposit_ = nullptr;
...
inline void UpdateAccount::unsafe_arena_set_allocated_deposit(::brokerage_to_bank::Deposit* deposit) {
  clear_payload();
  if (deposit) {
    set_has_deposit();
    _impl_.payload_.deposit_ = deposit;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:brokerage_to_bank.UpdateAccount.deposit)
}
inline ::brokerage_to_bank::Deposit* UpdateAccount::_internal_mutable_deposit() {
  if (!_internal_has_deposit()) {
    clear_payload();
    set_has_deposit();
    _impl_.payload_.deposit_ = CreateMaybeMessage< ::brokerage_to_bank::Deposit >(GetArenaForAllocation());
  }
  return _impl_.payload_.deposit_;
}
inline ::brokerage_to_bank::Deposit* UpdateAccount::mutable_deposit() {
  ::brokerage_to_bank::Deposit* _msg = _internal_mutable_deposit();
...
inline ::brokerage_to_bank::Ack_ResponseType Ack::_internal_response() const {
  return static_cast< ::brokerage_to_bank::Ack_ResponseType >(_impl_.response_);
}
...
inline void Ack::_internal_set_response(::brokerage_to_bank::Ack_ResponseType value) {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_brokerage_5fto_5fbank_2eproto
