...
// source: bankClient/common.proto

#include "bankClient/common.pb.h"
...
static ::_pb::Metadata file_level_metadata_bankClient_2fcommon_2eproto[4];
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_bankClient_2fcommon_2eproto[1];
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_bankClient_2fcommon_2eproto = nullptr;

const uint32_t TableStruct_bankClient_2fcommon_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_bankClient_2fcommon_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\027bankClient/common.proto\"\'\n\005Price\022\017\n\007do"
  ...
  ;
static ::_pbi::once_flag descriptor_table_bankClient_2fcommon_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_bankClient_2fcommon_2eproto = {
    false, false, 440, descriptor_table_protodef_bankClient_2fcommon_2eproto,
    "bankClient/common.proto",
    &descriptor_table_bankClient_2fcommon_2eproto_once, nullptr, 0, 4,
    schemas, file_default_instances, TableStruct_bankClient_2fcommon_2eproto::offsets,
    file_level_metadata_bankClient_2fcommon_2eproto, file_level_enum_descriptors_bankClient_2fcommon_2eproto,
    file_level_service_descriptors_bankClient_2fcommon_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_bankClient_2fcommon_2eproto_getter() {
  return &descriptor_table_bankClient_2fcommon_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_bankClient_2fcommon_2eproto(&descriptor_table_bankClient_2fcommon_2eproto);
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Magic_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_bankClient_2fcommon_2eproto);
  return file_level_enum_descriptors_bankClient_2fcommon_2eproto[0];
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Price::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_bankClient_2fcommon_2eproto_getter, &descriptor_table_bankClient_2fcommon_2eproto_once,
      file_level_metadata_bankClient_2fcommon_2eproto[0]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata BrokerageId::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_bankClient_2fcommon_2eproto_getter, &descriptor_table_bankClient_2fcommon_2eproto_once,
      file_level_metadata_bankClient_2fcommon_2eproto[1]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Header::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_bankClient_2fcommon_2eproto_getter, &descriptor_table_bankClient_2fcommon_2eproto_once,
      file_level_metadata_bankClient_2fcommon_2eproto[2]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata BuySell::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_bankClient_2fcommon_2eproto_getter, &descriptor_table_bankClient_2fcommon_2eproto_once,
      file_level_metadata_bankClient_2fcommon_2eproto[3]);
}
