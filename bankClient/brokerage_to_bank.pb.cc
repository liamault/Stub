...
// source: bankClient/brokerage_to_bank.proto

#include "bankClient/brokerage_to_bank.pb.h"
...
static ::_pb::Metadata file_level_metadata_bankClient_2fbrokerage_5fto_5fbank_2eproto[4];
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_bankClient_2fbrokerage_5fto_5fbank_2eproto[1];
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_bankClient_2fbrokerage_5fto_5fbank_2eproto = nullptr;

const uint32_t TableStruct_bankClient_2fbrokerage_5fto_5fbank_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_bankClient_2fbrokerage_5fto_5fbank_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\"bankClient/brokerage_to_bank.proto\032\014co"
  ...
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_bankClient_2fbrokerage_5fto_5fbank_2eproto_deps[1] = {
  &::descriptor_table_common_2eproto,
};
static ::_pbi::once_flag descriptor_table_bankClient_2fbrokerage_5fto_5fbank_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_bankClient_2fbrokerage_5fto_5fbank_2eproto = {
    false, false, 476, descriptor_table_protodef_bankClient_2fbrokerage_5fto_5fbank_2eproto,
    "bankClient/brokerage_to_bank.proto",
    &descriptor_table_bankClient_2fbrokerage_5fto_5fbank_2eproto_once, descriptor_table_bankClient_2fbrokerage_5fto_5fbank_2eproto_deps, 1, 4,
    schemas, file_default_instances, TableStruct_bankClient_2fbrokerage_5fto_5fbank_2eproto::offsets,
    file_level_metadata_bankClient_2fbrokerage_5fto_5fbank_2eproto, file_level_enum_descriptors_bankClient_2fbrokerage_5fto_5fbank_2eproto,
    file_level_service_descriptors_bankClient_2fbrokerage_5fto_5fbank_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_bankClient_2fbrokerage_5fto_5fbank_2eproto_getter() {
  return &descriptor_table_bankClient_2fbrokerage_5fto_5fbank_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_bankClient_2fbrokerage_5fto_5fbank_2eproto(&descriptor_table_bankClient_2fbrokerage_5fto_5fbank_2eproto);
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Ack_ResponseType_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_bankClient_2fbrokerage_5fto_5fbank_2eproto);
  return file_level_enum_descriptors_bankClient_2fbrokerage_5fto_5fbank_2eproto[0];
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Withdraw::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_bankClient_2fbrokerage_5fto_5fbank_2eproto_getter, &descriptor_table_bankClient_2fbrokerage_5fto_5fbank_2eproto_once,
      file_level_metadata_bankClient_2fbrokerage_5fto_5fbank_2eproto[0]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Deposit::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_bankClient_2fbrokerage_5fto_5fbank_2eproto_getter, &descriptor_table_bankClient_2fbrokerage_5fto_5fbank_2eproto_once,
      file_level_metadata_bankClient_2fbrokerage_5fto_5fbank_2eproto[1]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata UpdateAccount::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_bankClient_2fbrokerage_5fto_5fbank_2eproto_getter, &descriptor_table_bankClient_2fbrokerage_5fto_5fbank_2eproto_once,
      file_level_metadata_bankClient_2fbrokerage_5fto_5fbank_2eproto[2]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Ack::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_bankClient_2fbrokerage_5fto_5fbank_2eproto_getter, &descriptor_table_bankClient_2fbrokerage_5fto_5fbank_2eproto_once,
      file_level_metadata_bankClient_2fbrokerage_5fto_5fbank_2eproto[3]);
}
